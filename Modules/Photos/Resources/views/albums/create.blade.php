...
@section('content')
    <div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-6">
        ...
        <p class="text-sm text-gray-600 text-center mb-6">Immortalisez votre amour et partagez vos souvenirs avec vos invités 💍</p>
        ...
        <form action="{{ route('albums.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="mr_first_name" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500" value="{{ old('mr_first_name') }}" placeholder="John" required>
                </div>
                <div class="mb-4">
                    <label class="block">Nom Monsieur *</label>
                    <input type="text" name="mr_last_name" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500" value="{{ old('mr_last_name') }}" placeholder="Doe" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="mrs_first_name" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500" value="{{ old('mrs_first_name') }}" placeholder="Jane" required>
                </div>
                <div class="mb-4">
                    <label class="block">Nom Madame *</label>
                    <input type="text" name="mrs_last_name" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500" value="{{ old('mrs_last_name') }}" placeholder="Kayla" required>
                </div>
            </div>

            <div class="mb-4">
                <label for="album_title" class="block text-gray-700 font-medium mb-1">Titre album *</label>
                <input type="text" name="album_title" id="album_title" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="wedding_date" id="wedding_date" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500" required>
            </div>
