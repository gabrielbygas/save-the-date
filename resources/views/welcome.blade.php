    ...
    <div class="section" id="albums">
        ...
        <div class="two-col">
            <div>
                ...
                <p>Créez un album privé pour vos invités. Partagez via QR code et collectez tous vos souvenirs en un
                    seul endroit.</p>
                ...
                <a href="{{ route('photos.home') }}" class="btn btn-primary"
                    style="display: inline-block; margin-top: 24px;">Créer mon album</a>
            </div>

            <div class="mockup">
                <img src="{{ asset('images/qrcode.png') }}" alt="Exemple QR Code"
